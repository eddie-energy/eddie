...
| `EDDIE_RAW_DATA_OUTPUT_ENABLED`                                      | If set to `true`, supporting region connectors will publish the raw message as they receive it from the MDA to a dedicated outbound connector topic.                                                                                                                                                           |
