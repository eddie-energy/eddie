...
Explicitly granted commands (`UPDATE_TRANSMISSION_SCHEDULE`, `SET_TRANSMISSION_ENABLED`, `UPDATE_LIMIT_DEFAULTS`) are only accepted if the data need lists them in `allowedPermissionCommands`.
