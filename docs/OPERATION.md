...
| EDDIE_PERMISSION_REQUEST_TIMEOUT_DURATION                          | Sets the duration after which a permission request, which was neither accepted nor rejected, is considered stale.                                                                                                                                                                                            |
| EDDIE_PERMISSION_REQUEST_TIMEOUT_SCHEDULE                          | Sets the schedule when stale permission requests should be timed out. Uses Spring Cron syntax.                                                                                                                                                                                                               |
