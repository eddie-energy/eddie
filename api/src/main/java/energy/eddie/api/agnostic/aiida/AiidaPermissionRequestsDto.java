 ...
 * @param permissionIds IDs of these permissions as generated by this region connector. AIIDA will use the same IDs.
 ...
 */
public record AiidaPermissionRequestsDto(@JsonProperty UUID eddieId,
    ...
    private AiidaPermissionRequestsDto() {
        // for deserialization
