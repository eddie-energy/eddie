...
$separator = "===============================================================> "
Write-Output ($separator + "BUILD SW WITH GRADLE: clean")
Start-Process -NoNewWindow -Wait -FilePath "./gradlew" -ArgumentList "clean"
Write-Output ($separator + "BUILD SW WITH GRADLE: installDist")
Start-Process -NoNewWindow -Wait -FilePath "./gradlew" -ArgumentList "installDist"
