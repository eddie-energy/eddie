...
class IntermediateValidatedHistoricalDocumentTest {
    ...
    void testToVhd(
        ...
        assertTrue(XmlValidator.validateValidatedHistoricalMarketDocument(new String(bytes, StandardCharsets.UTF_8)));
    }
