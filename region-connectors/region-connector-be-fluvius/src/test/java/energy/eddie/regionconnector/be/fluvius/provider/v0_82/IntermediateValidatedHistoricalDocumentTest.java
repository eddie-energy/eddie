...
public class IntermediateValidatedHistoricalDocumentTest {
    ...
    void testGetGasVHD() throws IOException {
        ...
        streams.getMeteringData()
                .map(meteringDataList -> new IntermediateValidatedHistoricalDocument(fluviusConfig, meteringDataList, dataNeedsService))
                .subscribe(doc -> {
                    var res = doc.getVHD();
                    ...
                    assertAll(
                            ...
                            () -> assertEquals(fluviusConfig.clientId(),
        ...
        streams.getMeteringData()
                ...
                .subscribe(doc -> {
                    ...
                    assertAll(
                            ...
                            () -> assertEquals("PT1H", seriesPeriod.getResolution()),
