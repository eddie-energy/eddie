...
public class SupplyApiService {
    ...
    /**
     * Fetches the supply information for a given permission request. This method retrieves supply details based on the
     * NIF and distributor code provided in the permission request. It performs a series of validations including
     * checking for correct metering point and ensuring the point type supports the requested measurement type. If these
     * conditions are not met, appropriate exceptions are thrown.
     *
     * @param permissionRequest The permission request containing the NIF, distributor code, metering point ID, and
     *                          measurement type.
    ...
    public Mono<Supply> fetchSupplyForPermissionRequest(EsPermissionRequest permissionRequest) {
        ...
        return supplyApi.getSupplies(permissionRequest.nif(),
