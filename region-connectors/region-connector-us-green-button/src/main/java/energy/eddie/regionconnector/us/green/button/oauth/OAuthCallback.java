...
package energy.eddie.regionconnector.us.green.button.oauth;
...
public record OAuthCallback(Optional<String> code, Optional<String> error, String state) {
     ...
     *
     * @param code  When the user has authorized the application, the authorization server will redirect the user back
     *              to the application with an authorization code.
     * @param error When the user denies the application or there is an error, the authorization server will redirect
     *              the user back to the application with an error.
     * @param state Is the permissionId of the permission that was created when the user started the authorization
     *              process.
     */
