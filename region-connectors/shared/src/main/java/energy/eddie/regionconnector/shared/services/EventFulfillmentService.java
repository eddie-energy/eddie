...
public class EventFulfillmentService implements FulfillmentService {
    private static final Logger LOGGER = LoggerFactory.getLogger(EventFulfillmentService.class);
    private final Outbox outbox;
    private final BiFunction<String, PermissionProcessStatus, PermissionEvent> permissionEventCtor;

    public EventFulfillmentService(
            Outbox outbox,
