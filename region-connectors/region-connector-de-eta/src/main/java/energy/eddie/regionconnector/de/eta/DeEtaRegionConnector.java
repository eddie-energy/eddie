...
@Component
public class DeEtaRegionConnector implements RegionConnector {
    private static final Logger LOGGER = LoggerFactory.getLogger(DeEtaRegionConnector.class);
    private final DeEtaRegionConnectorMetadata metadata;
    private final Outbox outbox;
    private final DeEtaPermissionRequestRepository repository;

    public DeEtaRegionConnector(
