...
class CdsServerClientTest {
    ...
    private static ListingCredentials200Response createCredentials() {
        return new ListingCredentials200Response()
                .addCredentialsItem(
                        new ListingCredentials200ResponseAllOfCredentialsInner()
                                .clientId("customer-client-id")
                                .clientSecret("customer-client-secret")
                );
    }

    private static List<ClientEndpoint200ResponseAllOfClientsInner> createClient(
            URI uri,
            String scope,
            String clientId
    ) {
        return List.of(
                new ClientEndpoint200ResponseAllOfClientsInner()
                        .scope(scope)
                        .clientId(clientId)
