...
public record Energy01p40(
        at.ebutilities.schemata.customerprocesses.consumptionrecord._01p40.Energy energy) implements Energy {
    ...
    public List<EnergyData> energyData() {
        return energy.getEnergyData()
                     .stream()
                     .map(energyData -> (EnergyData) new EnergyData01p40(energyData))
                     .toList();
    }
