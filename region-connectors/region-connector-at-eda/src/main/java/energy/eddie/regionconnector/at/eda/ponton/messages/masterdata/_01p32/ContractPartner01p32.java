...
import at.ebutilities.schemata.customerprocesses.masterdata._01p32.NameC;
...
public record ContractPartner01p32(
        at.ebutilities.schemata.customerprocesses.masterdata._01p32.ContractPartner contractPartner) implements ContractPartner {
    @Override
    @Nullable
    ...
    public String companyName() {
        return Stream.of(
                             ...
                             getName(contractPartner.getName3()),
                             getName(contractPartner.getName4())
                     )
