...
import energy.eddie.regionconnector.at.eda.data.needs.calculation.strategies.EdaDataTimeframeStrategy;
import energy.eddie.regionconnector.at.eda.data.needs.calculation.strategies.EdaPermissionTimeframeStrategy;
...
public class AtEdaBeanConfig {
    ...
    public DataNeedCalculationService<DataNeed> dataNeedCalculationService(
        ...
        return new DataNeedCalculationServiceImpl(
                ...
                new EdaPermissionTimeframeStrategy(),
                new EdaDataTimeframeStrategy(),
                ruleSet
        );
    }
