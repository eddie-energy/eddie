...
public record Energy01p31(
        at.ebutilities.schemata.customerprocesses.consumptionrecord._01p31.Energy energy) implements Energy {
    ...
    public List<EnergyData> energyData() {
        return energy.getEnergyData()
                     .stream()
                     .map(energyData -> (EnergyData) new EnergyData01p31(energyData))
                     .toList();
    }
