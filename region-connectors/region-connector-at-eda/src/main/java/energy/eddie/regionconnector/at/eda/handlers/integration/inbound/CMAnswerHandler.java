...
@Component
public class CMAnswerHandler {
    private static final Logger LOGGER = LoggerFactory.getLogger(CMAnswerHandler.class);
    private final Outbox outbox;
    private final AtPermissionRequestRepository repository;

    public CMAnswerHandler(Outbox outbox, AtPermissionRequestRepository repository) {
        this.outbox = outbox;
        this.repository = repository;
    }


    public void handleCMAnswer(CMRequestStatus cmRequestStatus) {
