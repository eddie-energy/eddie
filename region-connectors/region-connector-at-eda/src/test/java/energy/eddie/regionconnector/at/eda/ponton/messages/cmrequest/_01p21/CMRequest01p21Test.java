...
class CMRequest01p21Test {
    ...
    void toCmRequestWithBlankConfig_throws() {
        ...
        var request = new CMRequest01p21(new CCMORequest(dsoIdAndMeteringPoint,
                                                         timeFrame,
                                                         cmRequestId,
                                                         mesageId,
    ...
    void toCmRequest_setsSchemaVersion_correctly() {
        ...
        // then
        assertEquals("01.21", res.getMarketParticipantDirectory().getSchemaVersion());
    }
    ...
    void toCmRequest_setsEnergyCommunityAttributes_correctly() {
        ...
        assertAll(
                ...
                () -> assertEquals(at.ebutilities.schemata.customerconsent.cmrequest._01p21.EnergyDirection.CONSUMPTION,
