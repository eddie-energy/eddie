...
class InboundMessageFactoryCollectionTest {
    ...
    @Test
    void updateActiveFactory_updatesCPNotificationFactory() {
        // Given
        EdaCPNotificationInboundMessageFactory cpNotificationFactory1 = mock(EdaCPNotificationInboundMessageFactory.class);
        when(cpNotificationFactory1.isActive(any())).thenReturn(true).thenReturn(false);
    ...
    private static EdaCPNotificationInboundMessageFactory simpleEdaCPNotificationFactory(boolean isActive) {
        return new EdaCPNotificationInboundMessageFactory() {
            @Override
            public boolean isActive(LocalDate date) {
                return isActive;
            }
