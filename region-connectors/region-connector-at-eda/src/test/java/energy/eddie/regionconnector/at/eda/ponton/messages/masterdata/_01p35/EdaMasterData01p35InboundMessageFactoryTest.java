...
class EdaMasterData01p35InboundMessageFactoryTest {
    ...
    void isActive_on_07_04_2024_returnsFalse() {
        // given
        var factory = new EdaMasterData01p35InboundMessageFactory(marshaller);
    ...
    @Test
    void isActive_on_08_10_2026_returnsTrue() {
        // given
        var factory = new EdaMasterData01p35InboundMessageFactory(marshaller);

        // when
        var active = factory.isActive(LocalDate.of(2026, 10, 8));
    ...
    void parseInputStream() throws IOException {
        // Given
        ClassLoader classLoader = EdaMasterData01p35InboundMessageFactory.class.getClassLoader();
        try (var inputStream = classLoader.getResourceAsStream("xsd/masterdata/_01p35/masterdata.xml")) {
            var factory = new EdaMasterData01p35InboundMessageFactory(marshaller);
            // When
