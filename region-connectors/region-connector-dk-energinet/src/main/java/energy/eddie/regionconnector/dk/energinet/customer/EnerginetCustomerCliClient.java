...
import energy.eddie.regionconnector.dk.energinet.customer.client.EnerginetCustomerApiClientDecorator;
import energy.eddie.regionconnector.dk.energinet.customer.model.MeteringPoints;
import energy.eddie.regionconnector.dk.energinet.customer.model.MeteringPointsRequest;
import energy.eddie.regionconnector.dk.energinet.util.DateTimeConverter;
...
public class EnerginetCustomerCliClient {
    ...
    public static void main(String[] args) throws IOException {
        ...
        EnerginetCustomerApiClientDecorator apiClientDecorator = new EnerginetCustomerApiClientDecorator(new EnerginetCustomerApiClient(refreshToken, propertiesEnerginetConfiguration));
