...
public class ValidatedHistoricalDataMarketDocumentBuilder {
    ...
    /**
     * The Global Location Number (GLN) of the sender of the message.
     * This value is from the <a href="https://api.eloverblik.dk/customerapi/index.html">API documentation</a> (from the API description linked in the description)
     */
    ...
    public ValidatedHistoricalDataMarketDocumentBuilder(String customerId, CodingSchemeTypeList eligiblePartyNationalCodingScheme, TimeSeriesBuilderFactory timeSeriesBuilderFactory) {
    ...
    public ValidatedHistoricalDataMarketDocumentBuilder withMyEnergyDataMarketDocument(MyEnergyDataMarketDocument myEnergyDataMarketDocument) {
        ...
        validatedHistoricalDataMarketDocument
                .withMRID(Optional.ofNullable(myEnergyDataMarketDocument.getmRID()).orElse(UUID.randomUUID().toString()))
                .withRevisionNumber(CommonInformationModelVersions.V0_82.version())
                .withType(MessageTypeList.MEASUREMENT_VALUE_DOCUMENT)
