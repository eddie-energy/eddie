...
class PropertiesEnedisConfigurationTest {
    ...
    void clientIdThrowsWhenNotSet() {
        ...
        // when
        // then
        assertThrows(NullPointerException.class, enedisConfiguration::clientId);
    }

    @Test
    void clientSecretThrowsWhenNotSet() {
        // given
        Properties props = new Properties();
        PropertiesEnedisConfiguration enedisConfiguration = new PropertiesEnedisConfiguration(props);
        ...
        // when
        // then
        assertThrows(NullPointerException.class, enedisConfiguration::clientSecret);
    }
