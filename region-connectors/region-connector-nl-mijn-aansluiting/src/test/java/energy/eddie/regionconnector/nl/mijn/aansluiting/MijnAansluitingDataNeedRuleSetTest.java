...
class MijnAansluitingDataNeedRuleSetTest {
    @Test
    void testDataNeedRuleSet() {
        // Given
        var ruleSet = new MijnAansluitingDataNeedRuleSet();
        ...
        assertThat(res)
                .containsExactlyInAnyOrder(
                        ...
                        new ValidatedHistoricalDataDataNeedRule(EnergyType.ELECTRICITY, List.of(Granularity.P1D)),
                        new ValidatedHistoricalDataDataNeedRule(EnergyType.NATURAL_GAS, List.of(Granularity.P1D))
                );
    }
}