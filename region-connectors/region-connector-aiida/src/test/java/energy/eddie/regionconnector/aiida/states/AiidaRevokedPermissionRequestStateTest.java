...
class AiidaRevokedPermissionRequestStateTest {
    @Test
    void status_returnsRevoked() {
        // Given
        AiidaRevokedPermissionRequestState state = new AiidaRevokedPermissionRequestState(null);

        // When
        // Then
        assertEquals(PermissionProcessStatus.REVOKED, state.status());
    }
