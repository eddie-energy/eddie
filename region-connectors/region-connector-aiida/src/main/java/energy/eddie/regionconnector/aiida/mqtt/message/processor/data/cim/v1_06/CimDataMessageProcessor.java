package energy.eddie.regionconnector.aiida.mqtt.message.processor.data.cim.v1_06;
...
@Component(value = "cimDataMessageProcessorV106")
public class CimDataMessageProcessor extends BaseMessageProcessor {
    ...
    @Override
    public void processMessage(MqttMessage message) throws IOException, PermissionNotFoundException, PermissionInvalidException {
    ...
    public String forTopicPath() {
        return AiidaSchema.SMART_METER_P1_CIM_V1_06.buildTopicPath(MqttTopicType.OUTBOUND_DATA.baseTopicName());
    }
}
