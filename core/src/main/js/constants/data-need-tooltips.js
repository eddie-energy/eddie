...
export const DATA_NEED_TOOLTIPS = {
  "account": [
    "Accounting Point Data",
    "Data need for accounting point information request, i.e. information about the customer and their metering point.",
  ],
  "validated": [
  ...
  "outbound-aiida": [
    "AIIDA Near Real-Time Outbound Data",
