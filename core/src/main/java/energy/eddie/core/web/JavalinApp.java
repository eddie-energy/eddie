...
public class JavalinApp {
        ...
        try (var app = Javalin.create(config -> {
            ...
            config.staticFiles.add(staticFileConfig -> {
                ...
                if (inDevelopmentMode()) {
                    ...
                    staticFileConfig.directory = "./core/src/main/resources/public/lib";
     ...
     * <p>
     * Enabling CORS is necessary for the eligible party app to use the custom elements provided by EDDIE and
     * region connectors.
     *
