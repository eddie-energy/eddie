...
public class TerminationKafkaConnector implements TerminationConnector {
    ...
    private final Flux<Pair<String, PermissionEnveloppe>> flux;
    ...
    public TerminationKafkaConnector(Properties kafkaProperties, String terminationTopic) {
        ...
        ReceiverOptions<String, PermissionEnveloppe> options = ReceiverOptions
                .<String, PermissionEnveloppe>create(kafkaProperties)
    ...
    private Pair<String, PermissionEnveloppe> process(ReceiverRecord<String, PermissionEnveloppe> rec) {
