...
* [EDDIE Framework operation manual](#eddie-framework-operation-manual)
    * [Quickstart](#quickstart)
    * [Installation](#installation)
    * [Update](#update)
    * [Integration](#integration)
        * [Using the EDDIE Button in an application](#using-the-eddie-button-in-an-application)
    * [Configuration](#configuration)
        * [Business domain related configuration](#business-domain-related-configuration)
            * [Data need configuration](#data-need-configuration)
        * [External system related](#external-system-related)
