...
public enum ObisCode {
    ...
    POSTIVIE_ACTIVE_ENERGY_IN_PHASE_L1("1-0:21.8.0", UnitOfMeasurement.KILO_WATT_HOUR),
    POSTIVIE_ACTIVE_ENERGY_IN_PHASE_L2("1-0:41.8.0", UnitOfMeasurement.KILO_WATT_HOUR),
    POSTIVIE_ACTIVE_ENERGY_IN_PHASE_L3("1-0:61.8.0", UnitOfMeasurement.KILO_WATT_HOUR),
