...
//    private static final String VENDOR_CARLO_GAVAZZI = "cbdfbd39-24c9-469f-bc7f-ef73b9834ec1";
//    private static final String VENDOR_OESTERREICHS_ENERGIE = "07e0b9ae-8b30-4cf9-8c3c-32de49e3aa56";
//
//    // Model UUIDs
//    private static final String MODEL_SIMULATION_DEFAULT = "15b77548-8a5e-41ab-a48a-93e024da6ef0";
//    private static final String MODEL_CARLO_GAVAZZI_EM24 = "9875b409-2040-4a2e-b8df-80c3e81bd3d7";
//    private static final String MODEL_OESTERREICHS_ENERGIE_ADAPTER = "91d8b15b-bb88-47d3-8425-15cf997bd1d9";
//
//    // Device UUIDs
...
//    private static final String DEVICE_CARLO_GAVAZZI_EM24_A = "26f5dbb2-d1a3-42cb-93d0-5e71ac62e5fc";
//    private static final String DEVICE_OESTERREICHS_ENERGIE_ADAPTER = "cfd870cd-fc1d-4288-bba5-414ceaf6e2d7";
//
//    private final List<ModbusVendor> vendors = List.of(
//            new ModbusVendor(VENDOR_SIMULATION, "Simulation"),
//            new ModbusVendor(VENDOR_CARLO_GAVAZZI, "Carlo Gavazzi"),
//            new ModbusVendor(VENDOR_OESTERREICHS_ENERGIE, "Oesterreichs Energie")
//    );
//
//    private final List<ModbusModel> modbusModels = List.of(
//            new ModbusModel(MODEL_SIMULATION_DEFAULT, "Simulation", VENDOR_SIMULATION),
//            new ModbusModel(MODEL_CARLO_GAVAZZI_EM24, "Carlo Gavazzi EM24", VENDOR_CARLO_GAVAZZI),
//            new ModbusModel(MODEL_OESTERREICHS_ENERGIE_ADAPTER, "Oesterreichs Energie Adapter", VENDOR_OESTERREICHS_ENERGIE)
//    );
//
...
//            new Device(DEVICE_CARLO_GAVAZZI_EM24_A, "Carlo Gavazzi EM24 Default", MODEL_CARLO_GAVAZZI_EM24),
//            new Device(DEVICE_OESTERREICHS_ENERGIE_ADAPTER, "Oesterreichs Energie Adapter", MODEL_OESTERREICHS_ENERGIE_ADAPTER)
//    );
//
...
public class ModbusDeviceService {
    ...
    // Extra constructor for testing with custom data
    public ModbusDeviceService(List<ModbusVendor> vendors, List<ModbusModel> modbusModels, List<Device> devices) {
