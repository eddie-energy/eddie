...
public class OesterreichsEnergieDataSource extends MqttDataSource {
    ...
    public OesterreichsEnergieDataSource(String name, boolean enabled, UUID userId, AiidaAsset asset, DataSourceType dataSourceType, String mqttServerUri, String mqttSubscribeTopic, String mqttUsername, String mqttPassword) {
