...
public interface PermissionRepository extends JpaRepository<Permission, String> {
     ...
     * <p>
     * <b>Important:</b> This will execute an eager load for {@link Permission#kafkaStreamingConfig()}.
     * </p>
     *
     ...
     */
    @EntityGraph(value = "graph.Permission.kafkaConfig", type = EntityGraph.EntityGraphType.LOAD)
