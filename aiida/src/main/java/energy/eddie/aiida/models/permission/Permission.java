...
public class Permission {
    ...
    /**
     * To be called after the customer has granted a new permission. Creates a new permission object with the status
     * ACCEPTED. If near real-time is requested, the resolution has to be 0 and the AggregationMethod NONE. The
     * streamingInterval has to be greater or equal to the resolution. If the streamingInterval is greater than the
     * resolution, multiple data points will be sent in batches.
     *
     ...
     * @param connectionId        ID generated by the EDDIE framework and that AIIDA sends along with every message to
     *                            the framework.
     * @param requestedCodes      Codes object containing which codes shall be shared with the EP.
     * @param mqttStreamingConfig {@link MqttStreamingConfig} for this permission.
     */
    public Permission(
            String permissionId,
            String serviceName,
            ...
            @Nullable MqttStreamingConfig mqttStreamingConfig
    ) {
        ...
        this.mqttStreamingConfig = mqttStreamingConfig;
     ...
     * @param expirationTime UTC timestamp when this permission expires and no more data should be shared.
     * @param grantTime      Timestamp when the user granted the permission.
     * @param connectionId   ID generated by the EDDIE framework and that AIIDA sends along with every message to the
     *                       framework.
     * @param requestedCodes Codes object containing which codes shall be shared with the EP.
     */
    public Permission(
     ...
     * {@link #updateStatus(PermissionStatus)} to indicate which of the two cases occurred.
     *
    ...
    /**
     * Returns the connectionId that was generated by the EDDIE framework and is sent along with each message to the
     * EP.
     */
