...
class OesterreichsEnergieAdapterDatasourceTest {
    @Test
    void testHashCode_And_Equals() {
        // given
        var atDataSourceConfig1 = new OesterreichsEnergieAdapterDatasource(true,
                                                                           "1",
                                                                           "tcp://example1.com",
                                                                           "test1",
                                                                           "",
                                                                           "");
        var atDataSourceConfig2 = new OesterreichsEnergieAdapterDatasource(true,
                                                                           "1",
                                                                           "tcp://example2.com",
                                                                           "test2",
                                                                           "",
                                                                           "");
        var atDataSourceConfig3 = new OesterreichsEnergieAdapterDatasource(true,
                                                                           "2",
                                                                           "tcp://example2.com",
                                                                           "test2",
                                                                           "",
        ...
        // when
        var atDataSourceConfigSet = new HashSet<OesterreichsEnergieAdapterDatasource>();
