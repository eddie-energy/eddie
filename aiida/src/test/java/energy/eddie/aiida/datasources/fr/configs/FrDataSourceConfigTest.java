...
class FrDataSourceConfigTest {
    @Test
    void testHashCode_And_Equals() {
        // given
        var frDataSourceConfig1 = new FrDataSourceConfig(true, "1", "tcp://example1.com", "test1", "", "", "meterId");
        var frDataSourceConfig2 = new FrDataSourceConfig(true, "1", "tcp://example2.com", "test2", "", "", "meterId");
        var frDataSourceConfig3 = new FrDataSourceConfig(true, "2", "tcp://example2.com", "test2", "", "", "meterId");

        // when
        var frDataSourceConfigSet = new HashSet<FrDataSourceConfig>();
