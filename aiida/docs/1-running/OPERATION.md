...
- **TimescaleDB
  **: A time-series database built on PostgreSQL. It is used to store information about permissions, information about datasources and time-series data.
- **EMQX**: An open-source MQTT broker that facilitates communication between datasources and AIIDA.
...
AIIDA uses Spring to expose health information for datasources.
