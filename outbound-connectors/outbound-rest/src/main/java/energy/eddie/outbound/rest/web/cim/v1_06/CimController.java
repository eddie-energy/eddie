package energy.eddie.outbound.rest.web.cim.v1_06;

import energy.eddie.cim.v1_06.rtd.RTDEnvelope;
import energy.eddie.outbound.rest.connectors.cim.v1_06.CimConnector;
...
import energy.eddie.outbound.rest.persistence.cim.v1_06.NearRealTimeDataMarketDocumentRepository;
...
public class CimController implements CimSwagger {
    ...
    public ResponseEntity<NearRealTimeDataMarketDocuments> nearRealTimeDataMd(
        ...
        Specification<NearRealTimeDataMarketDocumentModel> specification = CimSpecification.buildQueryForV1_06(
                permissionId,
                connectionId,
                dataNeedId,
                countryCode,
