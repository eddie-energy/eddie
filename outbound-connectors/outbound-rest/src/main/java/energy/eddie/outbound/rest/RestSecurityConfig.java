...
public class RestSecurityConfig {
    ...
    private Customizer<AuthorizeHttpRequestsConfigurer<HttpSecurity>.AuthorizationManagerRequestMatcherRegistry> authorizeHttpRequestsCustomizerWithScopes(
        ...
        return auth -> auth
                ...
                .requestMatchers(restRequestMatcher.matcher("/agnostic/permission-command")).hasAuthority("SCOPE_agnostic-permission-command:write")
                ...
                .requestMatchers(restRequestMatcher.matcher("/cim_1_12/request-permission-md")).hasAuthority("SCOPE_cim-permission-md:read")
