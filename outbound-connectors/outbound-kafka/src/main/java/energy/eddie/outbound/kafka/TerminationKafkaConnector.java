...
public class TerminationKafkaConnector implements TerminationConnector {
    ...
    @KafkaListener(groupId = "termination-group", id = "eddie-termination-listener", topics = "${kafka.termination.topic:terminations}", containerFactory = "listenerContainerFactory")
    public void process(
