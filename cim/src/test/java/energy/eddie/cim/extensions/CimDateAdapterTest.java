...
class CimDateAdapterTest {
    ...
    @Test
    void unmarshal_forISODateTime_returns() {
        // Given
    ...
    @Test
    void unmarshal_forISODate_returns() {
        // Given
        var expected = ZonedDateTime.of(2025, 1, 1, 0, 0, 0, 0, ZoneOffset.ofHours(1));
        var input = "2025-01-01+01:00";
        var adapter = new CimDateAdapter();
