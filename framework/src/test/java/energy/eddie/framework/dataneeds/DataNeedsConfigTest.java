...
import energy.eddie.framework.FrameworkSpringConfig;
...
class DataNeedsConfigTest {
    ...
    void testDataNeedsFromConfig() {
        app = new SpringApplicationBuilder(FrameworkSpringConfig.class)
    ...
    void testDataNeedsFromDbWithDataNeedInConfiguration() {
        var unstartedApp = new SpringApplicationBuilder(FrameworkSpringConfig.class)
                .properties("eddie.data-needs-config.data-need-source=DATABASE",
